...
@EnableCaching
@Profile("local")
@AutoConfigureAfter(value = {MetricsConfiguration.class, LocalDatabaseConfiguration.class})
public class LocalCacheConfiguration {
 
    private final Logger log = LoggerFactory.getLogger(LocalCacheConfiguration.class);
