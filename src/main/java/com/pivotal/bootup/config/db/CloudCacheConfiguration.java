...
import com.pivotal.bootup.config.MetricsConfiguration;
import com.pivotal.bootup.config.db.DevDatabaseConfiguration;
...
@EnableCaching
@Profile("cloud")
@AutoConfigureAfter(value = {MetricsConfiguration.class, CloudDatabaseConfiguration.class})
public class CloudCacheConfiguration {

    private final Logger log = LoggerFactory.getLogger(CloudCacheConfiguration.class);
